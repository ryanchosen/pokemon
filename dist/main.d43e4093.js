...
var fn = function fn() {
  console.log(n, _string.default.length);
  ...
  n < _string.default.length && (n = n + 1); // 每次从string中追加一个字符到substr里，如果遇到空格就追加转义字符，如果遇到换行就追加<br>
...
//# sourceMappingURL=main.d43e4093.js.map